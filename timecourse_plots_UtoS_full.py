...
if mode == 0:
    X_Y=[[153,29.25,112, 0]]
    X_Y_sm=[[182,29.25,112, 0]]
    X_Y_sl=[[191,29.25,112, 0]]
    X_Y_max=[[203,29.25,112, 0]]
...
if mode == 0:
    # save state_list
    with open('cenH_small_full_gUtoM29.25_AtoU112_S450.txt', 'wb') as F:
        pickle.dump(cenH_total_small, F)
        
    # save state_list
    with open('cenH_m_full_gUtoM29.25_AtoU112_S450.txt', 'wb') as F:
        pickle.dump(cenH_total_m, F)
        
    # save state_list
    with open('cenH_large_full_gUtoM29.25_AtoU112_S450.txt', 'wb') as F:
      pickle.dump(cenH_total_large, F)
        
    # save state_list
    with open('cenH_max_full_gUtoM29.25_AtoU112_S450.txt', 'wb') as F:
    ...
    # save state_list
    with open('EcoRV_small_full_gUtoM29.25_AtoU112_S450.txt', 'wb') as F:
        pickle.dump(EcoRV_total_small, F)
        
    # save state_list
    with open('EcoRV_m_full_gUtoM29.25_AtoU112_S450.txt', 'wb') as F:
        pickle.dump(EcoRV_total_m, F)
        
    # save state_list
    with open('EcoRV_large_full_gUtoM29.25_AtoU112_S450.txt', 'wb') as F:
        pickle.dump(EcoRV_total_large, F)
        
    # save state_list
    with open('EcoRV_max_full_gUtoM29.25_AtoU112_S450.txt', 'wb') as F:
...
if mode == 0:
    plt.savefig("timecourse_full_gUtoM29.25_AtoU112_S450.pdf")
