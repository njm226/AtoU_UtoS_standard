...
from AtoU_UtoS import t_loop
import AtoU_UtoS
import importlib
importlib.reload(AtoU_UtoS)
#import pandas as pd
...
#    loc = glo_loc[1]
    ...
    # global mode 1/x
    if global_mode==1:
        beta5 = 120*len(mt_region)#13.5*len(mt_region)#15*len(mt_region)#13.5 for SAU
...
# #values for 1/X (special set to 120)
# if __name__ == '__main__':
#     import time
#     #import cProfile
#     t1 = time.time()
...
# # #values for 1/(X^0.75) (special set to 250)
# if __name__ == '__main__':
#     import time
#     #import cProfile
#     t1 = time.time()
