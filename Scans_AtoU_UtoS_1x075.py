...
from smaller_model_function_AtoU_UtoS import simple_small as ss
from AtoU_UtoS_model import simple
...
if mode == 0:
        # save state_list
    with open('state_g_full_standard_AtoU_UtoS.txt', 'wb') as F:
          pickle.dump(state_list, F)

elif mode == 1:
        # save state_list
    with open('state_g_1x_standard_AtoU_UtoS.txt', 'wb') as F:
          pickle.dump(state_list, F)

    
elif mode == 2:
        # save state_list
    with open('state_g_1x075_standard_AtoU_UtoS.txt', 'wb') as F:
          pickle.dump(state_list, F)

elif mode == 3:
        # save state_list
    with open('state_g_1x05_standard_AtoU_UtoS.txt', 'wb') as F:
          pickle.dump(state_list, F)
          
elif mode == 4:
        # save state_list
    with open('state_g_1x025_standard_AtoU_UtoS.txt', 'wb') as F:
          pickle.dump(state_list, F)
...
if mode == 0:
    ...
    # save Timing list
    with open('b_list_1x_S120_standard_AtoU_UtoS.txt', 'wb') as F:
        pickle.dump(b_value_list, F)
    ...
    # save Timing list
    with open('b_list_1x075_S250_standard_AtoU_UtoS.txt', 'wb') as F:
        pickle.dump(b_value_list, F)
    ...
    # save Timing list
    with open('b_list_1x05_S200_standard_AtoU_UtoS.txt', 'wb') as F:
        pickle.dump(b_value_list, F)
